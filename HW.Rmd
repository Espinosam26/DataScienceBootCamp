...
```
Data Type: Numeric 
 The data given: x-variable is Time and the y-variable is Biochemical Oxygen Demand 
 The questions: What is the probability that the higher rates of Biochemical Oxygen Demand denotes low or poor water quality? What is the relationship between BOD and Time in regards to water quality? 
...
boxplot(BOD)
```
Notes: Both boxplots show pretty normal distributions. Although, the boxplot for Biochemical Oxygen Demand is slightly skewed to the right. No visible outliers. 
